# Per-pressure physical FRFs (PH to NC) from semi-anechoic runs — bump variant.
...
def _save_ph_tf_plot(
    *,
    ...
    ax_mag.set_title(f"PH Calibration TF Check ({p_si} psig) [bump]")
    ...
    *,
    ...
    for p_si, fcut in zip(pressures, cfg.F_CUTS):
        ...
        with h5py.File(out, "w") as hf:
            ...
            # H1/H2 live on. f1 == f2 when fs and nperseg match (they do here),
            # but save both for transparency.
            ...
            # Fused grid + fused TF kept as a diagnostic backup; bump's
