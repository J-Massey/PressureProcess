...
# Pipeline-equivalent to save_bump.fs_raw; only the Config source and
    ...
    *,
    ...
    with h5py.File(fs_raw, "w") as hf:
        ...
        hf.attrs["description"] = (
            "Raw freestream NC signals (fence). Pressures (0, 50, 100) psig "
            "with close+far pinhole spacings. Includes the simultaneous "
