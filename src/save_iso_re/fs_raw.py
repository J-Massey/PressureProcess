# Freestream raw pressure (NC channel) — iso_re variant.
    ...
    *,
    ...
    with h5py.File(fs_raw, "w") as hf:
        ...
        hf.attrs["description"] = (
            "Raw freestream NC signals (iso_re). Pressures (0, 30, 50) psig with "
            "only 'close' pinhole spacing. NC semi-anechoic calibration is not "
            "included because the available NC calib pressures don't match the "
            "run pressures."
        )
        ...
        for i, L in enumerate(labels):
            ...
            # iso_re: NC semi-anechoic calibration intentionally not included.
